...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  beforeMount: function beforeMount() {
    ...
    this.user = JSON.parse(localStorage.getItem('laravelVueStore.  d fuser'));
    axios.defaults.headers.common['Content-Type'] = 'application/json';
    axios.defaults.headers.common['Authorization'] = 'Bearer ' + localStorage.getItem('laravelVueStore.jwt');
  },
  methods: {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      name: null,
      user_type: 0,
      isLoggedIn: localStorage.getItem('laravelVueStore.jwt') != null
    };
  },
  mounted: function mounted() {
    this.setDefaults();
  ...
  methods: {
    setDefaults: function setDefaults() {
      if (this.isLoggedIn) {
        var user = JSON.parse(localStorage.getItem('laravelVueStore.user'));
        this.name = user.name;
        this.user_type = user.is_admin;
      }
    },
    change: function change() {
      this.isLoggedIn = localStorage.getItem('laravelVueStore.jwt') != null;
      this.setDefaults();
    },
    logout: function logout() {
      localStorage.removeItem('laravelVueStore.jwt');
      localStorage.removeItem('laravelVueStore.user');
      this.change();
      this.$router.push('/');
    }
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  beforeMount: function beforeMount() {
    ...
    if (localStorage.getItem('laravelVueStore.jwt') != null) {
      this.user = JSON.parse(localStorage.getItem('laravelVueStore.user'));
      axios.defaults.headers.common['Content-Type'] = 'application/json';
      axios.defaults.headers.common['Authorization'] = 'Bearer ' + localStorage.getItem('laravelVueStore.jwt');
    }
  },
    ...
    handleSubmit: function handleSubmit(e) {
      ...
      if (this.password.length > 0) {
        ...
        axios.post('api/login', {
          ...
          localStorage.setItem('laravelVueStore.user', JSON.stringify(user));
          localStorage.setItem('laravelVueStore.jwt', response.data.token);
  ...
  methods: {
    handleSubmit: function handleSubmit(e) {
      ...
      axios.post('api/register', {
        ...
        localStorage.setItem('laravelVueStore.user', JSON.stringify(data.user));
        localStorage.setItem('laravelVueStore.jwt', data.token);
    ...
    return _c(
      ...
      [
        _c("h2", { staticClass: "title" }, [
          _vm._v("Welcome to the Laravel Vue Store")
        ])
      ]
    )
  }
...
__webpack_require__(/*! /Users/cheejunwong/Sites/laravelVueStore/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/cheejunwong/Sites/laravelVueStore/resources/css/app.css */"./resources/css/app.css");
